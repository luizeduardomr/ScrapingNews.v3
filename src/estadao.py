...
def search(query, DIAi, MESi, ANOi, DIAf, MESf, ANOf):
    ...
    while c < valor:
        ...
        try:
            ...
            #   /html/body/section[4]/div/section[1]/div/div/section[3]   pag 1 noticia 3
            #   /html/body/section[4]/div/section[1]/div/div/div/section[1]    pag 2 noticia 1
            #   /html/body/section[4]/div/section[1]/div/div/div/div/section[1]    pag 3 noticia 1
        except:
            # Se nao tiver, acabou todas as noticias
            break
        # Tenta clicar no botão de Carregar Mais - a cada 10 notícias        
        if(i==1 or i==noticias):
            try:
                GET(f'/html/body/section[4]/div/section[1]/div/section[2]/div/a').click()
                pass
            except:
                try:
                    ...
                    print('erro para mudar de página')
                    pass
        ...
        #/html/body/section[4]/div/section[1]/div/section[2]/div/a #pag1
        # /html/body/section[4]/div/section[1]/div/div/section[11]/div/a #pag2
        # /html/body/section[4]/div/section[1]/div/div/div/section[11]/div/a #pag3
        # /html/body/section[4]/div/section[1]/div/div/div/div/section[11]/div/a #pag4
        # /html/body/section[4]/div/section[1]/div/div/div/div/div/section[11]/div/a #pag5
        # /html/body/section[4]/div/section[1]/div/div/div/div/div/div/section[11]/div/a #pag6

        # valor/10 = numero de paginas
        ...
        if isImagem == 0:
            ...
            isImagemtxt = 'Erro para verificar a imagem. l.108'
